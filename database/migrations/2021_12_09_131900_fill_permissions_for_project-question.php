...
class FillPermissionsForProjectQuestion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectQuestion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-question',
            'admin.project-question.index',
            'admin.project-question.create',
            'admin.project-question.show',
            'admin.project-question.edit',
            'admin.project-question.delete',
            'admin.project-question.bulk-delete',
        ]);
