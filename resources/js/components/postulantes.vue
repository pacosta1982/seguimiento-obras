    ...
    <div>
        <div class="row">
                            ...
                            <div class="row justify-content-md-between">
                                <div class="col col-lg-7 col-xl-5 form-group">
                                    <div class="input-group">
                                        <input class="form-control" ref="search" v-model="inputSat" @keyup.enter="getPostulante()" placeholder="Ingrese Documento de Postulante"  />
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4">
                    <p class="card-text"><strong>Solicitud:</strong> {{ this.proyecto }} </p>
                </div>
            </div>
            <div class="row">

                <div class="form-group col-sm-4">
                    <p class="card-text"><strong>Expediente:</strong> {{ this.Expediente }}  </p>
                </div>
                <div class="form-group col-sm-4">
                    <p class="card-text"><strong>Nivel:</strong> {{ this.Nivel }}  </p>
                </div>
                <div class="form-group col-sm-4">
                    <p class="card-text"><strong>Sat:</strong> {{ this.sat }} </p>
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    <p class="card-text"><strong>Fecha de Solicitud:</strong> {{ this.Fecha }} </p>
                </div>
                <div class="form-group col-sm-6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-primary">
        <p><strong>El numero de documento del postulante es requerido.</strong></p>
      </div>
    ...
    methods: {
        ...
        getPostulante() {
            ...
            if (!this.inputSat) {
                ...
                let me = this;
                var url = "/applicants/" + this.inputSat;
                this.isLoading = true;
                this.clearData();
